<template>
  <div class="timeline">
    <page-header 
      title="Life Timeline" 
      subtitle="A chronological journey through my life, professional career, and key milestones."
    />
...
.timeline-dot {
  ...
  box-shadow: 0 0 0 4px var(--dark-background), 0 0 0 6px rgba(125, 90, 250, 0.3);
}
